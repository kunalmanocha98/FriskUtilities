...
public class TextDrawable extends ShapeDrawable {
    ...
    public static TextDrawable getTextDrawable(String l, int width, int height) {
    ...
    public static TextDrawable getTextDrawable(String l, int width, int height, int color) {
    ...
    public static TextDrawable getTextDrawable(String latter) {
        ColorGenerator generator = ColorGenerator.MATERIAL;
        int color = generator.getRandomColor();
        return TextDrawable.builder()
                .beginConfig()
                ...
                .toUpperCase()
                .endConfig()
                .buildRect(latter, color);

    }



    public static TextDrawable getTextDrawable(String latter, int color) {
        return TextDrawable.builder()
                .beginConfig()
                .bold()
                .toUpperCase()
